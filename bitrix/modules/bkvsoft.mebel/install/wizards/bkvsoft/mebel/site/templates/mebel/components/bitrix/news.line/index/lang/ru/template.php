...
$MESS["ADD_OTZIV"] = "Добавить отзыв";
$MESS["LABEL_ARTICLE"] = "Артикул";
$MESS["ADD_V_KORZINU"] = "Добавить в корзину";
$MESS["ADDED_V_KORZINU"] = "Товар добавлен в корзину";
$MESS["DESCRIPTION"] = "ОПИСАНИЕ";
$MESS["COMMENTS"] = "ОТЗЫВЫ";
$MESS["MORE"] = "Подробно о товаре";
$MESS["OSTAVIT_OTZIV"] = "Оставить отзыв";
$MESS["YOU_NAME"] = "Ваше имя";
$MESS["YOU_E-MAIL"] = "Ваш e-mail";
$MESS["MESSAGE"] = "Сообщение";
$MESS["SEND"] = "Отправить";
$MESS["FOR DETAILS"] = "Подробнее";
$MESS["HITS"] = "ХИТЫ ПРОДАЖ";
