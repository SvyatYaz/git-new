...
<?endforeach?>
	...
	<table width="95%">
		<tr>
			...
			<input type="text" name="USER_LOGIN" maxlength="50" value="<?=$arResult["USER_LOGIN"]?>" size="17" style="border: 1px solid black;" />
            </div>
            </td>
		</tr>
		<tr>
			...
			<?=GetMessage("AUTH_PASSWORD")?>:<br />
              <div class="form-group">
			<input type="password" name="USER_PASSWORD" maxlength="50" size="17" style="border: 1px solid black;" />
            </div>
...
<?endif?>
		<tr>
			<td colspan="2"><input type="submit" name="Login"  class="btn btn-default btn-wd" value="<?=GetMessage("AUTH_LOGIN_BUTTON")?>" /></td>
		</tr>
