...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/katalogtovarov.xml"; 
	$iblockCode = "katalogtovarov"; //simvolnii kod infobloka
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/catalog/indexs.php", array("katalogtovarov_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/catalog/.left.menu.php", array("katalogtovarov_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/indexs.php", array("katalogtovarov_IBLOCK_ID" => $iblockID));
