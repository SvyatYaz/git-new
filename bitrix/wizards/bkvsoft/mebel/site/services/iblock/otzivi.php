...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/otzivi.xml"; 
	$iblockCode = "otzivi"; //simvolnii kod infobloka
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/ajax/comment.php", array("otzivi_IBLOCK_ID" => $iblockID));
