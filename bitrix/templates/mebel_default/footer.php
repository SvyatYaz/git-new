    ...
    <div class="row">
        <div class="col-sm-7 text-right pull-right">
            ...
            $APPLICATION->IncludeFile(
                SITE_DIR."include/registracia_lichniy_kabinet.php",
                Array(),
                Array("MODE"=>"html")
            );?>
        </div>
...
<script>
 $(document).ready(function() {
            $('#minibasket').load('<?echo SITE_DIR?>ajax/litelbasket.php');
            });
...
function ajaxcoment() { //Отправка коментария
    ...
    $.ajax({
        type: "POST",
        url: "<?echo SITE_DIR?>ajax/comment.php",
        data: msg,
  ...
  function ajaxaddcat() { //Добавления в корзинку
    ...
    $.ajax({
        type: "POST",
        url: "<?echo SITE_DIR?>ajax/addcat.php",
        data: msg,
        success: function(data) {
            $("#resaddcat").html(data);
            $('#minibasket').load('<?echo SITE_DIR?>ajax/litelbasket.php');
...
function ajaxreg() { //Регистрация
    ...
    $.ajax({
        type: "POST",
        url: "<?echo SITE_DIR?>ajax/reg.php",
        data: msg,
        success: function(data) {
            $("#results").html(data);
        },
...
function addzakaz() { //Оформления заказа
    ...
    $.ajax({
        type: "POST",
        url: "<?echo SITE_DIR?>ajax/reszakaz.php",
        data: msg,
        success: function(data) {
            $("#reszakaz").html(data);
        },
